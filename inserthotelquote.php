...
$sql = "INSERT INTO hotel_quotes (name, email, phone, checkin, checkout, board_basis, adults, children, infants, message) 
        VALUES ('$name', '$email', '$phone', '$checkin', '$checkout', '$board_basis', '$adults', '$children', '$infants', '$message')";
